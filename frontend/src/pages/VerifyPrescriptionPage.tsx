    ...
    <div className="min-h-screen bg-slate-50 font-sans flex flex-col justify-between">
      ...
      <main className="max-w-2xl w-full mx-auto px-4 py-8 sm:py-12 space-y-6">
        ...
        <form
          ...
          className="bg-white p-2.5 sm:p-3 rounded-2xl border border-border shadow-xs flex items-center gap-2"
        >
          <div className="relative flex-1">
            ...
            <input
              ...
              className="w-full bg-transparent border-0 text-ink text-sm sm:text-base font-mono font-bold pl-11 pr-4 py-2 focus:outline-none placeholder:font-sans placeholder:font-normal"
            />
          </div>
          <Button
            type="submit"
        ...
        {isLoading ? (
          <div className="bg-white p-8 rounded-2xl border border-border shadow-xs space-y-4">
            <Skeleton className="w-1/2 h-6 mx-auto" />
            <Skeleton className="w-3/4 h-4 mx-auto" />
            <Skeleton className="w-full h-32" variant="rect" />
          </div>
        ) : result && result.valid ? (
          <div className="bg-white rounded-2xl border border-teal-200 shadow-md p-6 sm:p-8 space-y-6 animate-fadeIn">
            {/* Authenticity Banner */}
            <div className="bg-emerald-50 border border-emerald-200 p-4 rounded-xl flex items-start gap-3.5">
